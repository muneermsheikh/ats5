...
namespace infra.Data.Migrations
{
    ...
    [Migration("20211031132215_InterviewItemCandidateFollowupAttendanceStatusIdAdded")]
    partial class InterviewItemCandidateFollowupAttendanceStatusIdAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("core.Entities.Admin.UserContacted", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("UsersContacted");
                });

            modelBuilder.Entity("core.Entities.Admin.UserContactedItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<DateTime>("NextReminderOn")
                        .HasColumnType("datetime2");

                    b.Property<string>("Remarks")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("UserContactedId")
                        .HasColumnType("int");

                    b.Property<int>("enumContactResult")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("UserContactedId");

                    b.ToTable("UserContactedItems");
                });
            ...
            modelBuilder.Entity("core.Entities.MasterEntities.AssessmentQBank", b =>
                {
                    ...
                    b.HasIndex("QNo", "CategoryId")
                        .IsUnique();

                    b.HasIndex("Question", "CategoryId")
                        .IsUnique();
            ...
            modelBuilder.Entity("core.Entities.Tasks.ApplicationTask", b =>
                {
                    ...
                    b.HasIndex("AssignedToId", "OrderItemId", "CandidateId", "TaskTypeId")
                        .IsUnique()
                        .HasFilter("[OrderItemId] IS NOT NULL AND [CandidateId] IS NOT NULL");
            ...
            modelBuilder.Entity("core.Entities.Admin.UserContactedItem", b =>
                {
                    b.HasOne("core.Entities.Admin.UserContacted", null)
                        .WithMany("UserContactedItems")
                        .HasForeignKey("UserContactedId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("core.Entities.Admin.UserContacted", b =>
                {
                    b.Navigation("UserContactedItems");
                });
