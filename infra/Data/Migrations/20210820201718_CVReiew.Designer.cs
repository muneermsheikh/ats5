...
namespace infra.Data.Migrations
{
    ...
    [Migration("20210820201718_CVReiew")]
    partial class CVReiew
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("core.Entities.HR.CVReview", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<int?>("CVReviewBySupId")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("core.Entities.HR.CVReviewByHRM", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("CVReviewByHRMs");
                });

            modelBuilder.Entity("core.Entities.HR.CVReviewBySup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<int>("CVReviewbyHRMId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("CVReviewbyHRMId")
                        .IsUnique();

                    b.ToTable("CVReviewBySups");
                });
            ...
            modelBuilder.Entity("core.Entities.HR.CVReview", b =>
                {
                    b.HasOne("core.Entities.HR.CVReviewBySup", "CVReviewBySup")
                        .WithOne()
                        .HasForeignKey("core.Entities.HR.CVReview", "CVReviewBySupId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.Navigation("CVReviewBySup");
                });

            modelBuilder.Entity("core.Entities.HR.CVReviewBySup", b =>
                {
                    b.HasOne("core.Entities.HR.CVReviewByHRM", "CVReviewByHRM")
                        .WithOne()
                        .HasForeignKey("core.Entities.HR.CVReviewBySup", "CVReviewbyHRMId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CVReviewByHRM");
                });
