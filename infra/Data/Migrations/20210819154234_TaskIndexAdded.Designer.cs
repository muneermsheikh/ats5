...
namespace infra.Data.Migrations
{
    ...
    [Migration("20210819154234_TaskIndexAdded")]
    partial class TaskIndexAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("core.Entities.HR.HRCVProcessing", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int>("HRSupProcessingId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("HRSupProcessingId")
                        .IsUnique();

                    b.HasIndex("CandidateId", "OrderItemId")
                        .IsUnique();

                    b.ToTable("HRCVProcessings");
                });

            modelBuilder.Entity("core.Entities.HR.HRMProcessing", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("HRMTaskId")
                        .IsUnique();

                    b.ToTable("HRMProcessings");
                });

            modelBuilder.Entity("core.Entities.HR.HRSupProcessing", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int>("HRMProcessingId")
                        .HasColumnType("INTEGER");

                    b.Property<int>("HRSupId")
                        .HasColumnType("INTEGER");

                    b.Property<string>("HRSupRemarks")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("HRMProcessingId")
                        .IsUnique();

                    b.ToTable("HRSupProcessings");
                });
            ...
            modelBuilder.Entity("core.Entities.Tasks.ApplicationTask", b =>
                {
                    ...
                    b.HasIndex("AssignedToId", "CandidateId", "TaskTypeId")
                        .IsUnique();
            ...
            modelBuilder.Entity("core.Entities.Tasks.TaskItem", b =>
                {
                    ...
                    b.Property<int?>("ApplicationTaskId1")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("core.Entities.HR.HRCVProcessing", b =>
                {
                    b.HasOne("core.Entities.HR.HRSupProcessing", "HRSupProcessing")
                        .WithOne()
                        .HasForeignKey("core.Entities.HR.HRCVProcessing", "HRSupProcessingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("HRSupProcessing");
                });

            modelBuilder.Entity("core.Entities.HR.HRSupProcessing", b =>
                {
                    b.HasOne("core.Entities.HR.HRMProcessing", "HRMProcessing")
                        .WithOne()
                        .HasForeignKey("core.Entities.HR.HRSupProcessing", "HRMProcessingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("HRMProcessing");
                });
            ...
            modelBuilder.Entity("core.Entities.Tasks.TaskItem", b =>
                {
                    b.HasOne("core.Entities.Tasks.ApplicationTask", "ApplicationTask")
                        .WithMany()
                    ...
                    b.HasOne("core.Entities.Tasks.ApplicationTask", null)
                        .WithMany("TaskItems")
                        .HasForeignKey("ApplicationTaskId1");
