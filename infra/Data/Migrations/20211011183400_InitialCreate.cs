        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderNo = table.Column<int>(type: "int", nullable: false),
                    OrderAddress_CompanyName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OrderAddress_Add = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OrderAddress_StreetAdd = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OrderAddress_Location = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OrderAddress_City = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OrderAddress_District = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OrderAddress_State = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OrderAddress_Pin = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OrderAddress_Country = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OrderAddress_OrderId1 = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApplicationTaskId1 = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                ...
                unique: true,
                filter: "[OrderItemId] IS NOT NULL AND [CandidateId] IS NOT NULL");
