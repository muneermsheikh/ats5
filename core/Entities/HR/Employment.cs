    ...
    public class Employment: BaseEntity
    {
        public Employment()
        {
          ...
          public Employment(int cVRefId, DateTime selectedOn, string salaryCurrency, int salary, 
                ...
                int leavePerYearInDays, int leaveAirfareEntitlementAfterMonths, DateTime offerAcceptedOn, 
                string categoryName, int orderItemId, int orderId, int orderNo, int customerId, int categoryId, 
                int candidateId, int applicationNo, string candidateName, string companyName, int charges)
          {
               CVRefId = cVRefId;
